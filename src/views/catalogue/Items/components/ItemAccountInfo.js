...
const ItemAccountInfo = (props) => {
    const dateFormat = useSelector((state) => state.locale.dateFormat)

    return (
        <>
            <h3 className="mx-4 mb-4 mt-2">ITEM DETAILS</h3>
                        ...
                        <Form>
                            <FormContainer>
                                <div className="md:grid grid-cols-4 gap-4 mx-4">
                                    ...
                                    <FormItem label="Incorporation Date">
                                        <Field
                                            name="dob"
                                    ...
                                    <FormItem label="Display Orientation *">
                                        <Field name="gender">
                                            {({ field, form }) => (
                                                <Select
...
export default ItemAccountInfo
