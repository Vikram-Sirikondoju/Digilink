export const wareHousesalesDashboardData = {
    statisticData: {
        revenue: {
            value: 21827.13,
            growShrink: 11.4,
...
export const wareHousesproductsData = [
    {
        id: '12',
        name: 'Luminaire Giotto Headphones',
        productCode: 'BIS-012',
...
export const wareHouseOrdersData = [
    {
        wareHouseId: 'R100010',
        location: 'Agarwal Electronics',
        actCapacity: 'Airtel India',
        usedCapacity:"Airtel Inc.",
        workOrder:"New Delhi, India",
        status: 0,
...
export const wareHousesorderDetailsData = [
    {
        id: '95954',
        progressStatus: 0,
        payementStatus: 0,
