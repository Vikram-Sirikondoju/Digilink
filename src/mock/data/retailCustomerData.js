export const retailssalesDashboardData = {
    statisticData: {
        revenue: {
            value: 21827.13,
            growShrink: 11.4,
...
export const retailsproductsData = [
    {
        id: '12',
        name: 'Luminaire Giotto Headphones',
        productCode: 'BIS-012',
...
export const retailsordersData = [
    {
        custId: 'R100010',
        custTiltle: 'Agarwal Electronics',
        custOperator: 'Airtel India',
        globalMno:"Airtel Inc.",
        address:"New Delhi, India",
        category:"Sensors",
        noOfOrders:'04',
        totalOrderValue:'$5,00,000.00',
        recentOrderDetails:"Sensors-10,03/10/2022",
        status: 0,
...
export const retailsorderDetailsData = [
    {
        id: '95954',
        progressStatus: 0,
        payementStatus: 0,
