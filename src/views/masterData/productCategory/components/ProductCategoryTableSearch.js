...
import { getOrders, getProdCatList, setTableData } from '../store/dataSlice'
import debounce from 'lodash/debounce'
import cloneDeep from 'lodash/cloneDeep'


const ProductCategoryTableSearch = () => {
...
export default ProductCategoryTableSearch
