...
import { getCustList, setTableData } from '../store/dataSlice'
import debounce from 'lodash/debounce'
import cloneDeep from 'lodash/cloneDeep'

const CustomerCategoryTableSearch = () => {
...
export default CustomerCategoryTableSearch
