export const providerssalesDashboardData = {
    statisticData: {
        revenue: {
            value: 21827.13,
            growShrink: 11.4,
...
export const providersproductsData = [
    {
        id: '12',
        name: 'Luminaire Giotto Headphones',
        productCode: 'BIS-012',
...
export const providersordersData = [
    {
        providerId: 'PL00001',
        providerTiltle: 'navya',
        category: 'GPS Tracker Sensors',
        operater:"Airtel Inc.",
...
export const providersorderDetailsData = [
    {
        id: '95954',
        progressStatus: 0,
        payementStatus: 0,
