...
import { getOrders, getTaxCompList, setTableData } from '../store/dataSlice'
import debounce from 'lodash/debounce'
import cloneDeep from 'lodash/cloneDeep'

const TaxComponentTableSearch = () => {
...
export default TaxComponentTableSearch
